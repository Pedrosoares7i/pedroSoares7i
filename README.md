...
### Desenvolvedor de Sistemas e Designer

Crio aplicações web, interfaces modernas, automações e soluções digitais para negócios.
...
Sistema SaaS de gestão desenvolvido para ajudar pequenos negócios a organizarem suas operações.

**Tecnologias:** React, C#, .NET e PostgreSQL.

### Insane's Tattoo

Sistema web de agendamento criado para um estúdio de tatuagem, com foco em uma experiência simples e moderna.

**Tecnologias:** React, JavaScript e CSS.

### Sabor & Alma

Redesign completo de um site de restaurante, priorizando identidade visual, responsividade e experiência do usuário.
